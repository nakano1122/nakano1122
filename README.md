...
ミュージアムにおける鑑賞支援や展示物推薦について研究していました。
...
## Development
### 「後で見ようと思ってブックマークした記事って二度と見なくない？」を解決するためのブックマーク記事管理・リマインドアプリ
Chromeでブックマークした記事を管理・リマインドするアプリを開発しました。
リマインダでは、「ユーザが過去にブックマークした記事と似ている」かつ「直近5日間にブックマークした」記事をpush通知で送信します。

- 個人開発（未リリース）
- [Repo](https://github.com/nakano1122/tsumudake)
